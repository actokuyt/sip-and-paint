...
export default function Home() {
  return (
    <div className="page-background w-screen h-screen p-2 pt-16">
      <img
        src="/logo.png"
        alt="logo"
      ...
      <ul className="flex justify-between text-[#927383] w-[50%] mx-auto mb-4">
        ...
        <li>
          <a href="https://www.instagram.com/estherkyeboah?igsh=MWl0OW5zNWpqZjJlcQ%3D%3D&utm_source=qr" className="">
